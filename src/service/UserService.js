...
export async function userLogIn(userName, password) {
  try {
    const response = await axios.post('https://54.161.152.240:443/api/user-login', {
      userName: userName,
      password: password
    })
...
export async function adminLogIn(userName, password) {
  try {
    const response = await axios.post('https://54.161.152.240:443/api/login', {
      userName: userName,
      password: password
    })
    if (response.status === 200) {
...
export async function getUsersList() {
  try {
    const response = await axios.get('https://54.161.152.240:443/api/get_all_teacher')
    if (response.status === 200) {
...
export async function createNewUser(userData) {  
  try {
    const response = await axios.post('https://54.161.152.240:443/api/save_teacher', userData)
...
export async function deleteUserById(id) {
  try {
    const response = await axios.delete(`https://54.161.152.240:443/api/delete_teacher/${id}`)
    if (response.status === 200) {
      return response.data.user
    } else {
...
export async function sendOTPToUser(param) {
  try {
    const response = await axios.post('https://54.161.152.240:443/api/send_otp', param)
    if (response.status === 200) {
      return response.data.user
    } else {
      throw new Error('Error at user login')
